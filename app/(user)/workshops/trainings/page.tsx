    ...
    <div className={"lt-container-small"}>
      ...
      <div className={"mx-10"}>
        <h2 className={"lt-page-h2"}>
          ტრენინგები განხორციელებული შემდეგ საგანმანათლებლო დაწესებულებების
          მასწავლებლებისთვის
        </h2>
        <div className={"mx-10 pb-16"}>
          ...
          <div className={"pb-16"}>
            ...
            <p>
              ...
              არსებული შეთანხმების თანახმად, ტრეინინგების კურსი მომზადებულია და
            ...
            <p>
              ...
              სასწავლებლების შესაბამისი პროგრამების კურსდამთავრებულების ცოდნასა
              და კომპეტენციებს
            </p>
          </div>
        ...
        <h4 className={"lt-page-h4"}>უცხოელი ტრენერები</h4>
        <div
          className={
