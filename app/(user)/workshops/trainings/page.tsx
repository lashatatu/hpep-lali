...
const Page = () => {
  return (
    <>
      <head>
        <title>{`თრენინგები | HPEP.GE`}</title>
      </head>
        ...
        <div className={"mx-10"}>
          {/*          <div className={"mx-10 pb-16"}>
            <h2 className={"lt-page-h2 text-center"}>
              შრომის დაცვისა და ჯანმრთელობის უსაფრთხოების თრენერთა თრენინგი
            </h2>
            <div className={"pb-16"}>
              <p>
              ...
              <p>
                ...
                არსებული შეთანხმების თანახმად, თრეინინგების კურსი მომზადებულია
              ...
              <p>
                თრეინინგების წარმატებით გავლის შემდგომ, თრეინინგში მონაწილეები
              ...
              <p>
                თრეინინგების კურსი განსაზღვრულია საქართველოში არსებული
            ...
            <h3 className={"lt-page-h3"}>
              სტუ-ს მხრიდან თრეინინგში მონაწილეობა მიიღეს და პირველი ეტაპის
            ...
            <p>2018 წლის მაისში იგეგმება ტრენერთა თრეინინგის მეორე ეტაპი</p>
          </div>
           // მეორე ბმული
          <div className={"mx-10 pb-16"}>
            <h2 className={"lt-page-h2 text-center"}>
            ...
            <div>
              <h3 className={"lt-page-h3 font-normal"}>
                თრეინინგი განხორციელდა InWent-ის მიერ (Capacity Building
