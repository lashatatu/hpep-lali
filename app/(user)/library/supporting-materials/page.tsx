const Page = () => {
  return (
    <>
      <head>
        <title>{`დამხმარე მასალები | HPEP.GE`}</title>
      </head>
        ...
        <div className={"mx-10"}>
          ...
          <div>
            ...
            <div>
              ...
              <p>
                ...
                traditional practical tasks--writing a course syllabus,
                delivering an effective lecture--as well as newer, broader
                concerns such as responding to diversity on campus and coping
                with budget constraints.
              </p>
              <p>Available at the UCB campus library | call # LB2331 .D37</p>
              <p>
                NEW! The entire book is also available online as part of
                netLibrary (accessible only through computers connected to the
            ...
            <div>
              <ul className={"lt-page-ul list-decimal"}>
                ...
                <li>
                  Guiding, Training, and Supervising Graduate Student
                  Instructors
                </li>
              ...
              <div>
                <ul className={"lt-page-ul list-disc"}>
                  ...
                  <li>
                    ...
                    by Joan Garfield (Journal of Statistics Education)
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div>
            ...
            <div>
              ...
              <p className={"indent-0"}>
                Mid-Term Course Evaluations (University of North Carolina –
                Chapel Hill)
              </p>
              <p className={"indent-0"}>
              ...
              <p className={"indent-0"}>
                Searchable CELT Tips Archive (On Jan. 27, 2005, some links will
                be temporarily broken, but will be fixed very soon.)
              </p>
            ...
            <ul className={"lt-page-ul  list-disc"}>
              ...
              <li>
                Collaborative Learning (National Institute for Science
                Education)
              </li>
              <li>
              ...
              <li>
                Implementing the Seven Principles: Technology as Lever (Arthur
