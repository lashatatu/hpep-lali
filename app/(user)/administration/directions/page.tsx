          ...
          <div>
            ...
            <div className={"lt-container-small pb-12"}>
              ...
              <ol className={"lt-page-ul-ol-padding list-decimal"}>
                ...
                <li>
                  ტრეინინგების მასალების ადაპტირება ზოგადად ქართულ რეალობასთან
                  და კონკრეტულად ტექნიკური უნივერსიტეტის მოთხოვნებთან
                </li>

                <li>
                  ტრეინინგების პაკეტების თარგმნა და მომზადება სწავლებისთვის
                </li>
          ...
          <div>
            ...
            <div className={"lt-container-small pb-12"}>
              ...
              <ol className={"lt-page-ul-ol-padding list-decimal"}>
                ...
                <li>
                  სტუ-ს სხვადასხვა ერთეულების ტრეინინგების ორგანიზება და
