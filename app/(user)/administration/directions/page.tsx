        ...
        <div>
          ...
          <div className={"lt-container-small pb-12"}>
            ...
            <ol className={"lt-page-ul-ol-padding list-decimal"}>
              ...
              <li>
                ტრეინინგების მონაწილეთა სერტფიცირება საზღვარგარეთელ
          ...
          <div className={"lt-container-small pb-12"}>
            ...
            <ul className={"lt-page-ul-ol-padding list-disc font-bold"}>
              ...
              <li>
                ACCC (Association of Canadian Community Colleges). Participated
                In Forum: “Local Ownership of Development”.
              </li>
              ...
              <li>
                ...
                International Relation of University of California, USA.
                Organizer Training courses in: “Innovative Teaching Techniques
                and Methodology”
              </li>
        ...
        <div>
          ...
          <div className={"lt-container-small pb-12"}>
            ...
            <ol className={"lt-page-ul-ol-padding list-decimal"}>
              ...
              <li>
                ტრეინინგების განხორციელება, შესაბამისი დამხმარე მასალებისა
          ...
          <div className={"lt-container-small pb-12"}>
            ...
            <ul className={"lt-page-ul-ol-padding list-disc font-bold"}>
              ...
              <li>
                ...
                Higher Professional Educational Program’s Business
                Administration Specialties. Manager.
              </li>
        ...
        <div>
          ...
          <div className={"lt-container-small pb-12"}>
            ...
            <ol className={"lt-page-ul-ol-padding list-decimal"}>
              ...
              <li>
                მასალების კოლექტირება და ბაზის შექმნა ელ.სწავლებისთვის ამერიკის
                და კანადის ტომსონ რივერ აიოვას უნივერსიტეტებთან თანამშრომლობით
              </li>
