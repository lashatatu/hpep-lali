  ...
  return (
    <div className={"lt-container"}>
      ...
      <div id={'first'} className={'flex max-lg:flex-col content-center justify-center lt-last-child '}>
        ...
        <a href={'#fifth'} className={'btn'}>NATO სტუდია</a>
      </div>
      {/*// first 1*/}
      <div>
        ...
        <div className={"lt-container-small pb-12"}>
          ...
          <ol className={"lt-page-ul-ol-padding list-decimal"}>
            <li>
              ტრეინინგების მასალების შესწავლა და კორექტირება (შექმნილია
            ...
            <li>
              მჭიდრო თანამშრომლობა სტუ-ს ხარისხის განვითარების სამსახურთან და
              ფაკულტეტების შესაბამის სამსახურებთან
            </li>
            ...
            <li>
              ტრეინინგების მასალების ადაპტირება ზოგადად ქართულ რეალობასთან და
              კონკრეტულად ტექნიკური უნივერსიტეტის მოთხოვნებთან
            </li>

            <li>ტრეინინგების პაკეტების თარგმნა და მომზადება სწავლებისთვის</li>

            <li>ტრეინინგების პილოტირება</li>

            <li>ტრეინინგების განხორციელება</li>

            <li>
              ტრეინინგების მონაწილეთა სერტფიცირება საზღვარგარეთელ პარტნიორებთან
              ერთობლივად
            </li>

            <li>ტრეინინგების შედეგების მონიტორინგი</li>
          </ol>
        </div>
        <div className={"lt-container-small pb-12"}>
        ...
        <div className={"lt-container-small pb-12"}>
          ...
          <ul className={"lt-page-ul-ol-padding list-disc font-bold"}>
            <li>
              Iowa State University, Ames, Iowa, US .The Center for Excellence
              in Learning and Teaching Workshop on Innovative Teaching
            ...
            <li>
              Project European Studies in the TEMPUS-TUNING project . COO3BO4) -
              “Tuning Educational Structures in Europe” ..Trainins.
            </li>
            ...
            <li>
              ...
              “Establishing Quality Assurance Services in the Georgian Higher
            ...
            <li>
              Series of Seminars on Establishment of Bologna Process Principles
              in Georgia
            </li>

            <li>
              American Conference of Academic Deans (ACAD) Leadership Workshop
              Certificate in ACAD Leadership.
            </li>

            <li>
              ACCC (Association of Canadian Community Colleges). Participated In
              Forum: “Local Ownership of Development”.
            </li>

            <li>
              Sigma Xi (The Scientific Research Society of American Scholars)
              Workshop on Research and Higher Education for Service of Society
              presented by Gretchen Kalonge – Director of Department of
              International Relation of University of California, USA. Organizer
              Training courses in: “Innovative Teaching Techniques and
              Methodology”
            </li>
            ...
            <li>
              Translation-adaptation & publication of the first year curriculums
              & textbooks for the professional centers of Akhalkalaki, Gori &
              Chiatura (MES, CCID,GTU),participant
            </li>

            <li>
              Science Education for New Civic Engagements and Responsibilities
              (usnsf, Harrisburg University, Ge
            </li>
          </ul>
        </div>
      </div>
      ...
      <div >
        ...
        <div className={"lt-container-small pb-12"}>
          <h3 className={"lt-page-h3"}>მიმართულების საქმიანობების აღწერა:</h3>
          <ol className={"lt-page-ul-ol-padding list-decimal"}>
            <li>დასაქმების ბაზრისა და დამსაქმებლების მოთხოვნების შესწავლა</li>

            <li>დაკვეთები საწარმოების თანამშრომელთა გადამზადებაზე;</li>

            <li>
              დაკვეთები საინჟინრო პროექტირებისა და განხორციელებული პროექტების
              ექსპერტიზაზე;
            </li>

            <li>
              პროფესიული განათლების სტანდარტებისა და პროგრამების შექმნასა და
              განხორციელებაში მონაწილეობა სტუ-ს ფაკულტეტებთან თანამშრომლობით;
            </li>

            <li>
              სწავლისა და სწავლების მეთოდოლოგიების გაზიარებისა და მათი
              პრაქტიკაში დანერგვის საკითხებში სტუ-ს ფაკულტეტებთან თანამშრომლობა;
            </li>

            <li>
              პროფესიული პროგრამების საწარმოო პრაქტიკის უზრუნველყოფა
              (პროგრამების მონიტორინგი, ხელშეკრულებების მონიტორინგი (განახლება
              და ახალის გაფორმება);
            </li>

            <li>
              ტრეინინგების მომზადება ბიზნესის მოთხოვნების შესაბამისად ბიზნეს
              ორგანიზაციებისა და საწარმოებებისათვის;
            </li>

            <li>
              ტრეინინგების სახელმძღვანელოების შექმნა ბიზნესის მოთხოვნების
              შესაბამისად;
            </li>

            <li>
              ტრეინინგების განხორციელება, შესაბამისი დამხმარე მასალებისა შექმნა
              და ჩატარების უზრუნველყოფა:
            </li>

            <li>
              პროფესიული სპეციალობების სტანდარტების მოდიფიცირების პროცესში
              მონაწილეობა საქართველოს შესაბამისი სტრუქტურებსა და საერთაშორისო
              ორგა
            </li>
          </ol>
        </div>
        <div className={"lt-container-small pb-12"}>
          ...
          <ul className={"lt-page-ul-ol-padding list-disc font-bold"}>
            ...
            <li>
              ENP – E – CP WP11 – 31- 08 GEO .ETF Expertise Provision for VET
              Curriculum Development Initiative in Georgia.
            </li>
            ...
            <li>
              USAID.Workforce Development Initiative for Shida Kartli Region,
              Tbilisi, Georgia.Manager.
            </li>
            ...
            <li>
              USAID project “ Successful Completion of a Professional Internship
              Guarantees a Graduate's Employment”.
            </li>

            <li>
              An Internship & Practice Program Proposed for Gori University’s
              Higher Professional Educational Program’s Business Administration
              Specialties. Manager.
            </li>

            <li>
              USAID project, “Shida Kartli region workforce education initiative
              for economic development” The SME support project, CCID. Manager
            </li>

            <li>
              Kirkwood Community College, Cedar Rapids, Iowa, US .Seminar in The
              National Center for Agrscience and
            </li>

            <li>
              Technology Education funded by the National Science Foundation
              (NSF) on Enhancing Faculty Development, Improving Curriculum and
              Instruction and Expending the skilled and Educated Workforce for
            ...
            <li>
              Moraine Valley, Palos Hills, Illinois, US Seminar on International
              Community Partnerships in Professional Education
            </li>
      ...
      {/*// third 3*/}
      <div >
        <h2 className={"lt-page-h2 text-center"}>სტუ-ს გალერეა „უნივერსი“</h2>
        <div className={"lt-container-small pb-12"}>
          ...
          <ol className={"lt-page-ul-ol-padding list-decimal"}>
            ...
            <li>
              სტუ-ის სხვადასხვა ერთეულების შეხვედრების ორგანიზება და ტექნიკური
              უზრუნველყოფა
            </li>
            ...
            <li>
              სტუ-ს სხვადასხვა ერთეულების ტრეინინგების ორგანიზება და ტექნიკური
              უზრუნველყოფ
            </li>
          </ol>
        </div>
      ...
      <div >
        ...
        <div className={"lt-container-small pb-12"}>
          ...
          <ol className={"lt-page-ul-ol-padding list-decimal"}>
            ...
            <li>
              დახელოვნების ცენტრის მიერ შექმნილი ვიდეო ტრეინინგების ჩაწერა,
      ...
      <div >
        ...
        <div className={"lt-container-small pb-12"}>
          ...
          <ol className={"lt-page-ul-ol-padding list-decimal"}>
            <li>
              ონლაინ სემინარებისა და ტრეინინგების განხორციელება საქართველოს
              სხვადასხვა უმაღლეს და პროფესიულ სასწავლებლებთან
            </li>

            <li>
              ლაბორატორიული სამუშაოების კომპიუტერული პროგრამების პილოტირება და
              დანერგვა საინჟინრო სპეციალობების საგნებისათვის
            </li>

            <li>
              Moodle-ის სტუდია (პედაგოგთა ტრეინინგები ელ.სწავლების
              მეთოდოლოგიებში)
            </li>

            <li>
              ლექციებისა და სწავლების სხვა ფორმების სასწავლო მასალის ფომატირება
              ელ. სწავლებისთვის
            </li>

            <li>
              მასალების კოლექტირება და ბაზის შექმნა ელ.სწავლებისთვის ამერიკის და
              კანადის ტომსონ რივერ აიოვას უნივერსიტეტებთან თანამშრომლობით
            </li>

            <li>
              კომპიუტერული პროგრამების პილოტირება და განხორციელება ლაბორატორიული
